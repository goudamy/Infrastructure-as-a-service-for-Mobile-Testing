...
public class FlavorDetail {
	...
	public static Hashtable getDetails(HttpResponse httpResponse,String hostUrl, int cnt) throws IOException {
					...
					try {
						...
						if(cnt == 0){
							PreparedStatement ps1 = ((java.sql.Connection) conn)
									.prepareStatement("truncate table instance_flavor");
							ps1.execute();
							ps1.close();
