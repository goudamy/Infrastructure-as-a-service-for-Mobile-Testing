...
function dt_val(){
  ...
  var t = "Admin";
  var v = "admin1234"
  if(frm.username.value.toLowerCase() != t.toLowerCase())
  {
    
    	try{BootstrapDialog.show({
            title: 'Invalid Username',
            message: 'The username entered is not valid!'
        });}catch(e){console.log("Username check")}finally{return false;}
  }
  else if(frm.password.value != v.toString())
  {
    try{BootstrapDialog.show({
            title: 'Invalid Password',
            message: 'The password entered is not correct!'
        });}catch(e){console.log("Password check")}finally{return false;}
