							...
							<ul class="dropdown-menu messages">
                            	...
                            	<li>
                                    <a href="#">
                                        ...
                                        <span class="message">
                                           Test Server Instance Creation Successful for Project 1.
                                        </span>  
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                        ...
                                        <span class="message">
                                            Mobile Resource added Successful for Project 1.
                                        </span>  
                                    </a>
                                </li>
                                <li>
				...
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li>
							...
							<ul>
								<li><a class="submenu" href="submenu.html"><i class="icon-file-alt"></i><span class="hidden-tablet"> Create an Instance</span></a></li>
								<li><a class="submenu" href="submenu2.html"><i class="icon-file-alt"></i><span class="hidden-tablet"> Terminate and Instance</span></a></li>
								<li><a class="submenu" href="submenu3.html"><i class="icon-file-alt"></i><span class="hidden-tablet"> List Instances</span></a></li>
							</ul>	
						</li>
						<li>
							<a class="dropmenu" href="#"><i class="icon-tasks"></i><span class="hidden-tablet"> Storage</span></a>
							<ul>
								<li><a class="submenu" href="submenu.html"><i class="icon-file-alt"></i><span class="hidden-tablet"> Create Storage</span></a></li>
								<li><a class="submenu" href="submenu2.html"><i class="icon-file-alt"></i><span class="hidden-tablet"> Delete Storage</span></a></li>
								<li><a class="submenu" href="submenu3.html"><i class="icon-file-alt"></i><span class="hidden-tablet"> List Storage</span></a></li>
							</ul>	
						</li>
						<li>
							...
							<ul>
								...
								<li><a class="submenu" href="submenu2.html"><i class="icon-file-alt"></i><span class="hidden-tablet"> Remove Image</span></a></li>
						...
						<li>
							...
							<ul>
								...
								<li><a class="submenu" href="submenu2.html"><i class="icon-file-alt"></i><span class="hidden-tablet"> Delete Flavor</span></a></li>
						...
						<li><a href="chart.html"><i class="icon-list-alt"></i><span class="hidden-tablet"> System Information</span></a></li>
					</ul>
				</div>
			</div>
			<!-- end: Main Menu -->
				...
				<div class="box black span4" onTablet="span6" onDesktop="span4">
					...
					<div class="box-content">
						<ul class="dashboard-list metro">
							<li class="green">
								<a href="#">
									<img class="avatar" alt="Admin" src="img/avatar.jpg">
								</a>
